...
class Solution {
  public static void main(String[] args) {
    ...
    list[0] = new Record("A1", "A", 0);
    list[1] = new Record("A1", "B", 2);
    list[2] = new Record("A1", "C", 4);
    list[3] = new Record("A1", "A", 5);
    list[4] = new Record("A2", "A", 0);
    list[5] = new Record("A2", "B", 1);
    list[6] = new Record("A2", "C", 3);
